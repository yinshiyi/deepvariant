aws emr create-cluster \
 ...
 --ec2-attributes '{"InstanceProfile":"ecsInstanceRole","EmrManagedMasterSecurityGroup":"sg-06aa995e5453d60e6","EmrManagedSlaveSecurityGroup":"sg-073b0c53976a0cae7","AdditionalMasterSecurityGroups":[],"AdditionalSlaveSecurityGroups":[],"SubnetId":"subnet-0ce2d946"}' \
